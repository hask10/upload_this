                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="login_leftbar_title" name="login_leftbar_title"
                                        class="form-control" value="{{ getSetting('login_leftbar_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="login_leftbar_colored_title"
                                        ...
                                        value="{{ getSetting('login_leftbar_colored_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="login_rightbar_title" name="login_rightbar_title"
                                        class="form-control" value="{{ getSetting('login_rightbar_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="login_rightbar_sub_title" name="login_rightbar_sub_title"
                                        class="form-control" value="{{ getSetting('login_rightbar_sub_title') }}">
                                </div>
