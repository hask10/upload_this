...
@section('title')
    {{ localize($template->name) }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="tt-page-header">
                        <div class="d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title mb-3 mb-lg-0">
                                <h1 class="h4 mb-lg-1">{{ localize($template->name) }}</h1>
                                    ...
                                    <form action="" method="POST" class="generate-contents-form"
                                        ...
                                        <div class="mb-4">
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="card" id="tt-advance-options">
                                                    <div class="card-body">
                                                        <div class="row g-3">
                                                            <div class="col-lg-6">
