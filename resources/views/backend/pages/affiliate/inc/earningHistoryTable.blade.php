    ...
    <tbody>
        @foreach ($earningHistories as $key => $history)
            <tr>
                ...
                <td>
                    <div>
                        {{ $history->subscriptionHistory->subscriptionPackage->title }}/{{ $history->subscriptionHistory->subscriptionPackage->package_type }}
                    </div>
                    <span class="fw-bold">{{ formatPrice($history->subscriptionHistory->price) }}</span>
                </td>
