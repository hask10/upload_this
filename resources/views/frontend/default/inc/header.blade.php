                                            ...
                                            @foreach ($groups as $group)
                                                <li class="nav-item" role="presentation">
                                                    <a href="pane{{ $group->id }}"
                                                        ...
                                                        aria-controls="pane{{ $group->id }}" aria-selected="true">
                                                        {{ $group->name }}
                                                    </a>
                                                </li>
                                            @endforeach
                                                            ...
                                                            @if ($template->template_group_id == $group->id)
                                                                <li><a
                                                                        href="{{ route('templates.show', $template->code) }}"><img
                                                                            ...
                                                                            width="24" alt=""
                                                                            class="me-2 rounded-circle">{{ $template->name }}</a>
                                                                </li>
                                                            @endif
                                                        @endforeach
                                                    </ul>
                ...
                <div class="d-flex align-items-center">
                    <a href="javascript:void(0)" class="btn btn-link p-1 tt-theme-toggle">
                        <div class="tt-theme-light" data-bs-toggle="tooltip" data-bs-placement="left"
                            data-bs-title="Dark"><i data-feather="moon" class="fs-lg"></i></div>
                        <div class="tt-theme-dark" data-bs-toggle="tooltip" data-bs-placement="left"
                            data-bs-title="Light"><i data-feather="sun" class="fs-lg"></i></div>
                    </a>
                                    ...
                                    <ul class="tt-template-list list-unstyled mb-0 d-flex flex-wrap">
                                        @foreach ($templates as $template)
                                            <li><a href="{{ route('templates.show', $template->code) }}"><img
                                                        src="{{ staticAsset('backend/assets/img/templates/' . $template->code . '.png') }}"
                                                        width="24" alt="" class="me-1 rounded-circle">
                                                    {{ $template->name }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
