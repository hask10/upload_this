                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="cta_colored_title" name="cta_colored_title"
                                        class="form-control" value="{{ getSetting('cta_colored_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="cta_heading_title" name="cta_heading_title"
                                        class="form-control" value="{{ getSetting('cta_heading_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="cta_short_description" name="cta_short_description"
                                        class="form-control" value="{{ getSetting('cta_short_description') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="cta_btn_title" name="cta_btn_title" class="form-control"
                                        value="{{ getSetting('cta_btn_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea rows="4" id="cta_features" name="cta_features" class="form-control">{{ getSetting('cta_features') }}</textarea>
