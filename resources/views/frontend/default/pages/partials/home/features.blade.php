        ...
        <div class="card text-light rounded-4 border-0 {{ isset($mt) ? 'mt--50' : '' }} overflow-hidden">
            ...
            <div
                ...
                <div class="position-relative">
                    <h4 class="card-title">{!! getSetting('feature_image_1_title') !!}</h4>
                    <p class="card-text">{{ getSetting('feature_image_1_short_description') }}</p>
                    <ul class="list-unstyled d-flex flex-wrap tt-two-col mt-4 mb-4">
                        <li class="py-2"><i data-feather="book-open" class="me-2"></i>{{ localize('Blog Content') }}
                        </li>
                        <li class="py-2"><i data-feather="mail" class="me-2"></i>{{ localize('Email Template') }}
                        </li>
                        <li class="py-2"><i data-feather="share-2" class="me-2"></i>{{ localize('Social Media') }}
                        </li>
                        <li class="py-2"><i data-feather="video" class="me-2"></i>{{ localize('Video Content') }}
                        </li>
                        ...
                        <li class="py-2"><i data-feather="code" class="me-2"></i>{{ localize('Medium Content') }}
                        </li>
                        <li class="py-2"><i data-feather="film" class="me-2"></i>{{ localize('Tik Tok') }}
                        </li>
                        <li class="py-2"><i data-feather="instagram" class="me-2"></i>{{ localize('Instagram') }}
                        </li>
                        <li class="py-2"><i data-feather="gift" class="me-2"></i>{{ localize('Success Story') }}
                        </li>
                    </ul>
                </div>
            </div>
