                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_1_title" name="how_it_works_1_title"
                                        class="form-control" value="{{ getSetting('how_it_works_1_title') }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_1_sub_title" name="how_it_works_1_sub_title"
                                        class="form-control" value="{{ getSetting('how_it_works_1_sub_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_1_short_description"
                                        ...
                                        value="{{ getSetting('how_it_works_1_short_description') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea rows="4" id="how_it_works_1_features" name="how_it_works_1_features" class="form-control">{{ getSetting('how_it_works_1_features') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_1_btn_title" name="how_it_works_1_btn_title"
                                        class="form-control" value="{{ getSetting('how_it_works_1_btn_title') }}">
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_2_title" name="how_it_works_2_title"
                                        class="form-control" value="{{ getSetting('how_it_works_2_title') }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_2_sub_title" name="how_it_works_2_sub_title"
                                        class="form-control" value="{{ getSetting('how_it_works_2_sub_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_2_short_description"
                                        ...
                                        value="{{ getSetting('how_it_works_2_short_description') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea rows="4" id="how_it_works_2_features" name="how_it_works_2_features" class="form-control">{{ getSetting('how_it_works_2_features') }}</textarea>
                                    <small>* {{ localize('Comma Separated: One, Two') }}</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_2_btn_title" name="how_it_works_2_btn_title"
                                        class="form-control" value="{{ getSetting('how_it_works_2_btn_title') }}">
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_3_title" name="how_it_works_3_title"
                                        class="form-control" value="{{ getSetting('how_it_works_3_title') }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_3_sub_title" name="how_it_works_3_sub_title"
                                        class="form-control" value="{{ getSetting('how_it_works_3_sub_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_3_short_description"
                                        ...
                                        value="{{ getSetting('how_it_works_3_short_description') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea rows="4" id="how_it_works_3_features" name="how_it_works_3_features" class="form-control">{{ getSetting('how_it_works_3_features') }}</textarea>
                                    <small>* {{ localize('Comma Separated: One, Two') }}</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_3_btn_title" name="how_it_works_3_btn_title"
                                        class="form-control" value="{{ getSetting('how_it_works_3_btn_title') }}">
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_4_title" name="how_it_works_4_title"
                                        class="form-control" value="{{ getSetting('how_it_works_4_title') }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_4_sub_title" name="how_it_works_4_sub_title"
                                        class="form-control" value="{{ getSetting('how_it_works_4_sub_title') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_4_short_description"
                                        ...
                                        value="{{ getSetting('how_it_works_4_short_description') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea rows="4" id="how_it_works_4_features" name="how_it_works_4_features" class="form-control">{{ getSetting('how_it_works_4_features') }}</textarea>
                                    <small>* {{ localize('Comma Separated: One, Two') }}</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="how_it_works_4_btn_title" name="how_it_works_4_btn_title"
                                        class="form-control" value="{{ getSetting('how_it_works_4_btn_title') }}">
                                </div>
